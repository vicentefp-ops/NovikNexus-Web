...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#F5F5F7] text-[#1D1D1F] font-sans selection:bg-[#901A1E] selection:text-white overflow-x-hidden">
      ...
      {/* Footer */}
      <footer className="py-24 px-6 bg-[#0A0A0A] text-white border-t border-white/10">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row justify-between gap-20">
          <div className="flex flex-col items-start gap-8 lg:w-1/3">
            <Logo light />
            <div className="flex gap-6 text-white/50 mt-2">
          ...
          <div className="flex flex-col sm:flex-row gap-16 lg:gap-32 w-full lg:w-auto">
            ...
            <div className="flex flex-col gap-4">
              <h3 className="text-[13px] tracking-[0.25em] font-medium uppercase text-white/40 mb-2">PORTFOLIO</h3>
              <a href="#ecosystem" className="text-sm font-medium text-[#E5E5E5] hover:text-white transition-colors flex items-center group w-max tracking-wide">
                Novik <ArrowUpRight strokeWidth={2} className="w-4 h-4 ml-1 opacity-60 group-hover:opacity-100 transition-opacity" />
              </a>
              <a href="#ecosystem" className="text-sm font-medium text-[#E5E5E5] hover:text-white transition-colors flex items-center group w-max tracking-wide">
                PerioVox <ArrowUpRight strokeWidth={2} className="w-4 h-4 ml-1 opacity-60 group-hover:opacity-100 transition-opacity" />
              </a>
              <a href="#ecosystem" className="text-sm font-medium text-[#E5E5E5] hover:text-white transition-colors flex items-center group w-max tracking-wide">
                Chromic <ArrowUpRight strokeWidth={2} className="w-4 h-4 ml-1 opacity-60 group-hover:opacity-100 transition-opacity" />
              </a>
              <span className="text-sm font-medium text-white/30 tracking-wide mt-1">
                Dentwise · soon
              </span>
              <span className="text-sm font-medium text-white/30 tracking-wide mt-1">
                Implantik · soon
            ...
            {/* LEGAL */}
            <div className="flex flex-col gap-4">
              <h3 className="text-[13px] tracking-[0.25em] font-medium uppercase text-white/40 mb-2">LEGAL</h3>
              <a href="/privacy-policy.html" target="_blank" rel="noopener noreferrer" className="text-sm font-medium text-[#E5E5E5] hover:text-white transition-colors w-max tracking-wide mt-1">
                Privacy
              </a>
              <a href="/terms-of-use.html" target="_blank" rel="noopener noreferrer" className="text-sm font-medium text-[#E5E5E5] hover:text-white transition-colors w-max tracking-wide mt-1">
                Terms
              </a>
            </div>
          </div>
